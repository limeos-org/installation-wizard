...
void initialize_ui(void)
{
    ...
    if (has_colors())
    {
        ...
        if (use_extended_colors)
        {
            ...
            init_pair(CUSTOM_COLOR_PAIR_PRIMARY_ODD, CUSTOM_COLOR_BLUE, CUSTOM_COLOR_ROW_ODD_BG);
            init_pair(CUSTOM_COLOR_PAIR_PRIMARY_EVEN, CUSTOM_COLOR_BLUE, CUSTOM_COLOR_ROW_EVEN_BG);
        }
        else
        {
            ...
            init_pair(CUSTOM_COLOR_PAIR_PRIMARY_ODD, COLOR_BLUE, COLOR_WHITE);
            init_pair(CUSTOM_COLOR_PAIR_PRIMARY_EVEN, COLOR_BLUE, COLOR_WHITE);
        }
    }
